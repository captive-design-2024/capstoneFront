    ...
    <footer className="bg-gray-900 text-white py-6 px-6">
      <div className="container mx-auto flex flex-col items-center space-y-8">
        ...
        <div className="flex items-center space-x-4">
          ...
          <a href="https://twitter.com/captive_design" target="_blank" rel="noopener noreferrer" className="text-sm hover:underline">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-5 h-5 mr-1"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
              <path d="M23.643 4.937a10.347 10.347 0 0 1-2.828.775 4.931 4.931 0 0 0 2.165-2.724 10.041 10.041 0 0 1-3.127 1.2A4.917 4.917 0 0 0 16.217 3c-2.707 0-4.917 2.197-4.917 4.917 0 .387.045.764.129 1.126A13.978 13.978 0 0 1 1.671 3.149a4.93 4.93 0 0 0-.666 2.474c0 1.707.867 3.213 2.183 4.096a4.897 4.897 0 0 1-2.228-.616v.061c0 2.379 1.689 4.366 3.934 4.825-.412.112-.845.171-1.293.171-.315 0-.623-.031-.926-.087a4.923 4.923 0 0 0 4.586 3.415A9.867 9.867 0 0 1 0 19.54a13.936 13.936 0 0 0 7.548 2.211c9.056 0 14.005-7.492 14.005-13.975 0-.212-.004-.425-.013-.637A10.016 10.016 0 0 0 24 4.59a9.806 9.806 0 0 1-2.357.645A4.917 4.917 0 0 0 23.643 4.937z" />
            </svg>
          </a>
        </div>
      </div>
